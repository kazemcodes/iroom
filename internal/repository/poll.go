...
func (r *PollRepo) Create(p *models.Poll) error {
...
func (r *PollRepo) ListBySession(sessionID int64) ([]*models.Poll, error) {
	rows, err := r.db.Query(
...
func (r *PollRepo) Vote(vote *models.PollVote) error {
...
func (r *PollRepo) GetVote(pollID, userID int64) (*models.PollVote, error) {
	v := &models.PollVote{}
	err := r.db.QueryRow(
...
func (r *PollRepo) GetResults(pollID int64) (*models.PollResults, error) {
	// Get poll details
