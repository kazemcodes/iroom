...
func (r *ClassRepo) ListByStudent(studentID int64) ([]entity.Class, error) {
	rows, err := r.db.Query(
...
func (r *ClassRepo) ListAll(page, perPage int, search string) ([]entity.Class, int64, error) {
	var total int64
...
func (r *ClassRepo) GetStudents(classID int64) ([]entity.User, error) {
	rows, err := r.db.Query(
...
func (r *ClassRepo) Update(c *entity.Class) error {
	_, err := r.db.Exec(
...
func (r *ClassRepo) GetByInviteCode(code string) (*entity.Class, error) {
	c := &entity.Class{}
	err := r.db.QueryRow(
...
func (r *ClassRepo) GetByIDWithInvite(id int64) (*entity.Class, error) {
	c := &entity.Class{}
	err := r.db.QueryRow(
