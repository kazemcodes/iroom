...
func (r *FileRepo) Create(f *entity.File) error {
...
func (r *FileRepo) GetByID(id int64) (*entity.File, error) {
	f := &entity.File{}
	err := r.db.QueryRow(
...
func (r *FileRepo) ListBySession(sessionID int64) ([]entity.File, error) {
	rows, err := r.db.Query(
...
func (r *FileRepo) Search(query string, limit, offset int) ([]entity.File, int64, error) {
	var total int64
