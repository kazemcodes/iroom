...
func (r *TicketRepo) Create(t *entity.Ticket) error {
...
func (r *TicketRepo) GetByID(id int64) (*entity.Ticket, error) {
	t := &entity.Ticket{}
	err := r.db.QueryRow(
...
func (r *TicketRepo) ListByUser(userID int64, page, perPage int) ([]entity.Ticket, int64, error) {
	var total int64
...
func (r *TicketRepo) ListAll(page, perPage int, search string) ([]entity.Ticket, int64, error) {
	var total int64
...
func (r *TicketRepo) SendMessage(m *entity.TicketMessage) error {
	result, err := r.db.Exec(
...
func (r *TicketRepo) ListMessages(ticketID int64) ([]entity.TicketMessage, error) {
	rows, err := r.db.Query(
