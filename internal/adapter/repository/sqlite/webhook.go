...
func (r *WebhookRepo) Create(w *entity.Webhook) error {
...
func (r *WebhookRepo) GetByID(id int64) (*entity.Webhook, error) {
	w := &entity.Webhook{}
...
func (r *WebhookRepo) ListByUserID(userID int64) ([]entity.Webhook, error) {
	rows, err := r.db.Query(
...
func (r *WebhookRepo) ListAll() ([]entity.Webhook, error) {
	rows, err := r.db.Query(
...
func (r *WebhookRepo) GetActiveByEventType(eventType string) ([]entity.Webhook, error) {
	rows, err := r.db.Query(
...
func (r *WebhookRepo) Update(w *entity.Webhook) error {
	eventsJSON, err := json.Marshal(w.Events)
	if err != nil {
		return err
	}
...
func (r *WebhookDeliveryRepo) Create(d *entity.WebhookDelivery) error {
	result, err := r.db.Exec(
...
func (r *WebhookDeliveryRepo) ListByWebhookID(webhookID int64, page, perPage int) ([]entity.WebhookDelivery, int64, error) {
	var total int64
	err := r.db.QueryRow(
