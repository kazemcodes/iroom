...
func (r *RecordingRepo) Create(rec *entity.Recording) error {
...
func (r *RecordingRepo) GetByID(id int64) (*entity.Recording, error) {
...
func (r *RecordingRepo) ListBySession(sessionID int64) ([]entity.Recording, error) {
	rows, err := r.db.Query(
...
func (r *RecordingRepo) ListAll(page, perPage int, search string) ([]entity.Recording, int64, error) {
	var total int64
