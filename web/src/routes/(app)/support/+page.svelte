			...
			<div class="flex items-center gap-3">
				...
				<div>
					...
					<div class="flex items-center gap-2 mt-1">
						...
						<span class="text-xs px-2.5 py-1 rounded-full font-medium {priorityColors[ticketDetail.priority]}">{priorityLabels[ticketDetail.priority]}</span>
	...
	{:else}
		...
		<div class="flex items-center justify-between">
			<div>
				...
				<p class="text-gray-500 mt-1">{tickets.length} تیکت</p>
			</div>
