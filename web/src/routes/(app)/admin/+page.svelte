...
<div class="space-y-6">
	...
	<div class="flex items-center gap-3 flex-wrap">
		...
		<div class="flex gap-1">
			<button onclick={() => goto('/admin/rooms')} class="px-3 py-2 text-sm text-gray-600 hover:bg-gray-100 rounded-lg">اتاق‌ها</button>
			...
			<button onclick={() => goto('/support')} class="px-3 py-2 text-sm text-gray-600 hover:bg-gray-100 rounded-lg">تیکت‌ها</button>
